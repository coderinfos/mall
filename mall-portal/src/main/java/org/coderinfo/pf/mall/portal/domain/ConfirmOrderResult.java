...
public class ConfirmOrderResult {
    ...
    //用户收货地址列表
    private List<UacMemberReceiveAddress> memberReceiveAddressList;
    //用户可用优惠券列表
    private List<SmsCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    private UacIntegrationConsumeSetting integrationConsumeSetting;
    //会员持有的积分
    ...
    public List<UacMemberReceiveAddress> getMemberReceiveAddressList() {
        return memberReceiveAddressList;
    }

    public void setMemberReceiveAddressList(List<UacMemberReceiveAddress> memberReceiveAddressList) {
    ...
    public UacIntegrationConsumeSetting getIntegrationConsumeSetting() {
        return integrationConsumeSetting;
    }

    public void setIntegrationConsumeSetting(UacIntegrationConsumeSetting integrationConsumeSetting) {
