package org.coderinfo.pf.mall.demo.config;

import org.coderinfo.pf.mall.demo.bo.AdminUserDetails;
    ...
    public UserDetailsService userDetailsService() {
        ...
        return new UserDetailsService() {
            ...
            public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
                ...
                List<UacAdmin> UacAdminList = UacAdminMapper.selectByExample(example);
                if (UacAdminList != null && UacAdminList.size() > 0) {
                    return new AdminUserDetails(UacAdminList.get(0));
                }
